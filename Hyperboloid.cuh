#ifndef HYPERBOLOID_CUH
#define HYPERBOLOID_CUH

#include "RigidEntity.h"
#include <math.h>
#include "Matrix4.h"

class Hyperboloid : public RigidEntity
{
public:
	__device__	Hyperboloid(matrix4& transform, Material* mat, float radius, float length);
...
__device__ Hyperboloid::Hyperboloid(matrix4& transform, Material* mat, float radius, float length)
{
	_mat = mat;
	_radius = radius;
...
__device__ Hyperboloid::~Hyperboloid()
{
}

__device__ bool	Hyperboloid::gotHit(Ray& ray, float& t, vec4& pos, vec4& normal, Material** mat)
{
